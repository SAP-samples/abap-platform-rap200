...
> [!IMPORTANT]
> ⚠️**Info for the RAP200 Dry Run - INFO only available SAP-internally and will be DELETED AFTER THE DRY RUN**⚠️
> 
>> - System ID: **`AI5`**
>>   
>> - System URL: **`https://811b8f03-fcbb-4aef-84ea-be223d95c35d.abap.eu10.hana.ondemand.com`**
>>   
>> - Username: **`developer-###@abapcloud.sap`**, where **`###`** is your personal suffix assigned by the instructors
>>   
>> - Password: **`Welcome1!`**

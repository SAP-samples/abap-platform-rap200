...
| [Exercise 6: Using the Backgroung Processing Framework (bgPF)](exercises/ex06/README.md) | -- |
...
This exercise block enhances the transactional capabilities of the _Manage Travel_ app built in the exercise block A.
 ...
 💡**Prequisites**: Completion of Exercise Block A
...
| [Exercise 3: Add Collaborative Draft](exercises/ex03/README.md) | -- |
| [Exercise 4: Add Event-Driven Side Effects](exercises/ex04/README.md) | -- |
| [Exercise 5: Using the Backgroung Processing Framework (bgPF)](exercises/ex05/README.md) | -- |
...
> You can import the solution package **`ZRAP200_001`** (for now :-)) ~**`ZRAP200_SOL`**~ into the following systems:
